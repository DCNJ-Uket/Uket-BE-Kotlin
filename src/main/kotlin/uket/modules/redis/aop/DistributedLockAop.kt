package uket.uket.modules.redis.aop
...
import uket.uket.modules.redis.util.CustomSpringELParser
...
class DistributedLockAop(
    ...
    @Around("@annotation(uket.uket.modules.redis.aop.DistributedLock)")
