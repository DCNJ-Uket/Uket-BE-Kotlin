...
import uket.uket.common.response.ListResponse
...
class EventController(
    ...
    fun getEventRounds(
        ...
        uketEventService.validateNowTicketing(event)

        val eventRounds = uketEventRoundService.findByUketEventId(eventId)
    ...
    fun getEntryGroups(
        ...
        val entryGroups = entryGroupService.findByUketEventRoundId(eventRoundId)
