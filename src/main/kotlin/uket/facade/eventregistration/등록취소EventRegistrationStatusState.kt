...
class 등록취소EventRegistrationStatusState(
    ...
    override fun execute(id: Long, currentStatus: EventRegistrationStatus) {
        when (currentStatus) {
            EventRegistrationStatus.검수_진행 -> doNothing
            EventRegistrationStatus.검수_완료 -> 검수완료To등록취소(id)
            EventRegistrationStatus.등록_완료 -> 등록완료To등록취소(id)
    ...
    private fun 검수완료To등록취소(id: Long) {
    ...
    private fun 등록완료To등록취소(id: Long) {
        val eventRegistration = eventRegistrationService.findById(id)
        val uketEventId = eventRegistration?.uketEventId
